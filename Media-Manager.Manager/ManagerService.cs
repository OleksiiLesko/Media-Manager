...
namespace Media_Manager.Manager
{
    ...
    public class ManagerService : ServiceBase
    {
        ...
        {
            _logger.LogInformation("Media-Manager service is starting");
            ...
            _logger.LogInformation("Media-Manager service is started");
        }
        ...
        protected override void OnStop()
        {
            ...
            _logger.LogInformation("Media-Manager service is  stopped");
        }
    }
}
